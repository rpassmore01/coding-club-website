  ...
  return (
    <div className={styles.titleContainer}>
      <div className="flex flex-col content-center justify-center p-20">
        <h2 className="text-6xl font-bold font-['Poppins'] px-1 py-1 text-light-gray text-center lg:text-left">
          Westmount Coding Club
        </h2>

        <p className="text-1xl font-medium font-['Poppins']  py-1 text-light-gray text-center lg:text-left">
        ...
        >
          <button className="text-2xl w-full text pb-0.5 h-10 bg-royal-blue text-light-gray font-bold rounded-full font-['Poppins'] w-2/3">
            Announcements
          </button>
        </a>
